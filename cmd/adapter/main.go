...
import (
	...
	"github.com/dcberg/kubernetes-sysdig-metrics-apiserver/internal/cmprovider"
	"github.com/dcberg/kubernetes-sysdig-metrics-apiserver/internal/sdc"

	// Temporar hack until I can vendor it.
	_cma_server "github.com/dcberg/kubernetes-sysdig-metrics-apiserver/internal/custom-metrics-apiserver/pkg/cmd/server"
	_cma_dynamicmapper "github.com/dcberg/kubernetes-sysdig-metrics-apiserver/internal/custom-metrics-apiserver/pkg/dynamicmapper"
)
