...
import (
	...
	"github.com/sevein/k8s-sysdig-adapter/internal/custom-metrics-apiserver/pkg/cmd/server"
	"github.com/sevein/k8s-sysdig-adapter/internal/custom-metrics-apiserver/pkg/dynamicmapper"
	"github.com/sevein/k8s-sysdig-adapter/internal/custom-metrics-apiserver/pkg/sample-cmd/provider"
)
